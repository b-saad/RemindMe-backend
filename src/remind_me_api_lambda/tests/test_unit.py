...
def test_is_event_in_current_scheduling_window_valid(mocker):
    ...
    result = remind_me_api._is_event_in_current_scheduling_window(valid_timestamp)
...
def test_is_event_in_current_scheduling_window_right_bound(mocker):
    ...
    result = remind_me_api._is_event_in_current_scheduling_window(invalid_timestamp)
